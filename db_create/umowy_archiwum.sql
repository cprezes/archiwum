...
--
-- Baza danych: `umowy_archiwum`
--
CREATE DATABASE IF NOT EXISTS `umowy_archiwum` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `umowy_archiwum`;
...
CREATE TABLE IF NOT EXISTS `rejestr_umow` (
  ...
  `uzytkownik_id` int(11) DEFAULT NULL,
  `data` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `kategoria` tinytext CHARACTER SET utf8 COLLATE utf8_polish_ci,
