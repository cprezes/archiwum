...
if ($Gdzie_jestem == "archiwum/archiwum.php") {
    $mysqlDbName = constant("dbarch");
} elseif ($Gdzie_jestem == "umowy/umowy.php") {
    $mysqlDbName = constant("dbumowy");
} elseif ($Gdzie_jestem == "pieczecie/pieczecie.php") {
    $mysqlDbName = constant("dbpieczecie");
} else {
    die();
}   //przy zaminie popraw  ten badziew w plikach index.php archiwum i umowy
